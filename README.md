...
## 核心发现（详见 [基准报告 v0.2](docs/benchmark-report-v0.2.md)）

| 发现 | 数据 |
|------|------|
| 整体 ASR | 4.0% (45/1128)，英文 HarmBench 通常 30-70% |
| 完全免疫技术 | 13/20 种（DAN/提示注入/逆向心理等全 0%） |
| 唯一有效攻击面 | **"重新框定"**——历史讨论包装 40%、影视角色扮演 16%、隐喻寓言 15% |

**结论：中文模型安全对齐强度被英文社区系统性低估约 10 倍。唯一有效攻击是"重新框定"，尤其"历史讨论包装"。**
